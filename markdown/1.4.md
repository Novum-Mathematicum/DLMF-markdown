...
![Figure 1.4.1: Piecewise continuous function on $[a,b)$ .](1/4/F1.png)
:::{note}
**Symbols:**
...
![Figure 1.4.2: Convex function $f(x)$ . $g(t)=f((1-t)c+td)$ , $l(t)=(1-t)f(c)+tf(d)$ , $c,d\in(a,b)$ , $0\leq t\leq 1$ .](1/4/F2.png)
:::{note}
**Symbols:**
