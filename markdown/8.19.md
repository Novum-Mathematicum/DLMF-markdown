...
![Figure 8.19.1: $E_{p}\left(x\right)$ , $0\leq x\leq 3$ , $0\leq p\leq 8$ . 3D Help](8/19/F1.png)
:::{note}
**Symbols:**
...
![Figure 8.19.2: $E_{\frac{1}{2}}\left(x+iy\right)$ , $-4\leq x\leq 4$ , $-4\leq y\leq 4$ . Principal value. There is a branch cut along the negative real axis. 3D Help](8/19/F2.png)
:::{note}
**Symbols:**
...
![Figure 8.19.4: $E_{\frac{3}{2}}\left(x+iy\right)$ , $-3\leq x\leq 3$ , $-3\leq y\leq 3$ . Principal value. There is a branch cut along the negative real axis. 3D Help](8/19/F4.png)
:::{note}
**Symbols:**
